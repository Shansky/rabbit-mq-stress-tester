...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		cli.StringFlag{Name: "vhost, vh", Value: "/", Usage: "vhost for RabbitMQ server"},
...
func runApp(c *cli.Context) {
	println("Running!")
	porto := "amqp://"
	uri := porto + c.String("user") + ":" + c.String("password") + "@" + c.String("server") + ":" + c.String("port") + "/" + c.String("vhost")
